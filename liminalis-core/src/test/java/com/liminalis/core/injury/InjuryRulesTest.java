...
class InjuryRulesTest {
    ...
    private static final InjurySettings SETTINGS = new InjurySettings(0.25, 0.40, 0.60, 0.35);

    /** Chances forced to certainty, so threshold behaviour can be tested on its own. */
    private static final InjurySettings ALWAYS = new InjurySettings(0.25, 1.0, 0.60, 1.0);
    ...
    void aMassiveBlowThatDoesNotMaimStillCountsAsALargeOne() {
        ...
        InjurySettings mortalNeverInjuryAlways = new InjurySettings(0.25, 1.0, 0.60, 0.0);
    ...
    void zeroChanceMeansNothingEverHappens() {
        InjurySettings never = new InjurySettings(0.25, 0.0, 0.60, 0.0);
